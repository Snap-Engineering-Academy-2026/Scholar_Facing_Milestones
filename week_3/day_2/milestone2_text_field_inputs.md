...
At this point, the code is incomplete, we haven't finished chaining our promise! We need to handle our promise state - look back at the slide if you a little lost here. I'll drop these hints to help get you started. Replace your `app.js` with the code below. Fill out the items needed to make this code run!
